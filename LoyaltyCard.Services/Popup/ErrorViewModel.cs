...
namespace LoyaltyCard.Services.Popup
{
    ...
    {
        private readonly IPopupService _modalPopupService;
    ...
    internal class ErrorViewModelDesignData : ErrorViewModel
    {
        public ErrorViewModelDesignData() : base(null, new Exception())
        {
